...
$data = "mch_id=" . $mch_id . "&notify_url=" . $notify_url . "&out_trade_no=" . $out_trade_no . "&pay_type=" . $pay_type . '&remark=' . $remark . '&return_url=' . $return_url . '&total_fee=' . $total_fee . '&version=' . $version . "&" . $key;
$sign = md5($data);
...
$url .= 'version=' . $version . '&mch_id=' . $mch_id . '&out_trade_no=' . $out_trade_no . '&total_fee=' . $total_fee . '&pay_type=' . $pay_type . '&notify_url=' . $notify_url . '&return_url=' . $return_url . '&remark=' . $remark . '&sign=' . $sign;
header("location:".$url);
//echo '<a href="'.$url.'">前往支付</a>';
die();
